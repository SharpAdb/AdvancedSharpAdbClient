...
#endif
    [DebuggerDisplay($"{NamespaceDoc.Name}.{nameof(LogEntry)} \\{{ {nameof(PayloadLength)} = {{{nameof(PayloadLength)}}}, {nameof(HeaderSize)} = {{{nameof(HeaderSize)}}}, {nameof(ProcessId)} = {{{nameof(ProcessId)}}}, {nameof(ThreadId)} = {{{nameof(ThreadId)}}}, {nameof(TimeStamp)} = {{{nameof(TimeStamp)}}}, {nameof(NanoSeconds)} = {{{nameof(NanoSeconds)}}}, {nameof(Id)} = {{{nameof(Id)}}}, {nameof(Uid)} = {{{nameof(Uid)}}}, {nameof(Data)} = {{{nameof(Data)}}} }}")]
