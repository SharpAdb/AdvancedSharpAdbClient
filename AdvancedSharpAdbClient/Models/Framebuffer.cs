...
namespace AdvancedSharpAdbClient.Models
{
    ...
    public sealed partial class Framebuffer(DeviceData device, EndPoint endPoint, Func<EndPoint, IAdbSocket> adbSocketFactory) : IDisposable, IInternalCloneable<Framebuffer>
    {
        /// <summary>
