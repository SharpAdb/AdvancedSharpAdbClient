...
namespace AdvancedSharpAdbClient.Tests
{
    ...
    public class SyncServiceTests : SocketBasedTests
    {
        ...
        public void StatTest()
        {
            ...
            Assert.Equal(UnixFileType.Regular, value.FileMode & UnixFileType.TypeMask);
        ...
        public void GetListingTest()
        {
            ...
            Assert.Equal((UnixFileType)41471, sdcard0.FileMode);
            ...
            Assert.Equal((UnixFileType)16749, emulated.FileMode);
