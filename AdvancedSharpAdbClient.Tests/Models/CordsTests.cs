...
{
    /// <summary>
    /// Tests the <see cref="Cords"/> class.
    /// </summary>
    public class CordsTests
    {
        ...
        public void ArithmeticTest(int x, int y)
        {
            ...
            Assert.Equal(addExpected, Cords.Add(p, s));
            Assert.Equal(subExpected, Cords.Subtract(p, s));
        }
        ...
        public void CordsFMathematicalTest(float x, float y)
        {
            ...
            Assert.Equal(pCeiling, Cords.Ceiling(pf));
            Assert.Equal(pRound, Cords.Round(pf));
            Assert.Equal(pTruncate, Cords.Truncate(pf));
        }
