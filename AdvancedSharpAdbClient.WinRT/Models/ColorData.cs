...
namespace AdvancedSharpAdbClient.WinRT
{
    ...
    {
        internal AdvancedSharpAdbClient.ColorData colorData;
        ...
        public uint Length
        {
            get => colorData.Length;
            set => colorData.Length = value;
        }
        ...
        public uint Offset
        {
            get => colorData.Offset;
            set => colorData.Offset = value;
        }
        ...
        internal ColorData(AdvancedSharpAdbClient.ColorData colorData) => this.colorData = colorData;

        internal static ColorData GetColorData(AdvancedSharpAdbClient.ColorData colorData) => new(colorData);
        ...
        public void Deconstruct(out uint length, out uint offset) => colorData.Deconstruct(out length, out offset);
    }
}
